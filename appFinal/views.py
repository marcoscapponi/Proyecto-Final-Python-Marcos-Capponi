...
# def editarEstudios(request, estudios_nombre):
#     estudio = Estudios.objects.get(nombreEstudio = estudios_nombre)
#     if request.method == "POST":
#         miFormulario4 = estudiosFormulario(request.POST)
#         print(miFormulario4)
#         if miFormulario4.is_valid:
#             informacion = miFormulario4.cleaned_data
#             estudio.nombreEstudio = informacion['nombreEstudio']
#             estudio.duracion = informacion['duracion']
#             estudio.instituto = informacion['instituto']
#             estudio.save()
#             return render(request, "appFinal/inicio.html")
#     else:
#         miFormulario4 = estudiosFormulario(initial={'nombreEstudio': estudio.nombreEstudio, 'duracion': estudio.duracion, 'instituto': estudio.instituto})
#     return render(request, "appFinal/editarEstudio.html", {"miFormulario4": miFormulario4, "estudios_nombre": estudios_nombre})